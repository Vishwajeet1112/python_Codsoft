...
class GUI():
    def __init__(self,master):
        ...
        self.label = Label(text="Password Generator CodSoft", anchor=N, fg='darkblue', font='arial 20 bold underline')
        ...
        self.generate = Button(text="GENERATE PASSWORD", bd=3, relief='solid', padx=1, pady=1, font='forte 15 bold', fg='white', bg='#ff8000', command=self.generate_pass)
